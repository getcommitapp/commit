    ...
    <ScreenLayout largeTitle>
      {isLoading ? (
        <View style={{ padding: 24, alignItems: "center" }}>
          <ActivityIndicator />
          <ThemedText style={{ marginTop: 12 }}>Loading your groups...</ThemedText>
        </View>
      ) : isError ? (
        <View style={{ padding: 24, alignItems: "center" }}>
          ...
          <ThemedText onPress={() => refetch()} style={{ marginTop: 12, textDecorationLine: "underline" }}>
            Tap to retry
          </ThemedText>
        </View>
      ) : groups && groups.length === 0 ? (
        <View style={{ padding: 24, gap: 8 }}>
          <ThemedText style={textVariants.bodyEmphasized}>No groups yet</ThemedText>
